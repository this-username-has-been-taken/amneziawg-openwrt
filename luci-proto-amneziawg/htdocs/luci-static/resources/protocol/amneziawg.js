...
return network.registerProtocol('amneziawg', {
	...
	renderFormOptions(s) {
        ...
        try {
            s.tab('amneziawg', _('AmneziaWG Settings'), _('Further information about AmneziaWG interfaces and peers at %s.'.format('<a href=\'https://docs.amnezia.org/documentation/amnezia-wg\'>amnezia.org</a>')));
        }
        catch(e) {}
		...
		try {
			s.tab('peers', _('Peers'), _('Further information about AmneziaWG interfaces and peers at %s.'.format('<a href=\'https://docs.amnezia.org/documentation/amnezia-wg\'>amnezia.org</a>')));
		}
		catch(e) {}
